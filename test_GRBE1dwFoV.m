% test_GRBE1dwFoV.m programmed by Tomo Furukawa
clear all;
close all;
...
%S(1).xk = -2; S(2).xk = -1; S(3).xk = 2; S(4).xk = 3;
S(1).detectFlag = 0;    S(2).detectFlag = 1;
S(3).detectFlag = 0;    S(4).detectFlag = 1;
S(2).zk = 1.09;  S(4).zk = 0.82;
